...
int main()
{
    ...
    cout << "Enter color: " << endl << "1-Black; 2-Blue; 3-Green; 4-Cyan; 5-Red; 6-Violet; 7-Yellow;" << endl << "8-White; 9-Grey; 10-Light-blue; 11-Light-green; 12-Light-cyan;" << endl << "13-Light-red;14-Light-violet; 15-Light-Yellow; 16-Light-white" << endl;
    cin >> Color;
    Name[0] = Color;
